...
const cspHeader = `
    ...
    connect-src https://clerk.seemail.dev https://*.clerk.accounts.dev https://*.clerk.com ${process.env.NEXT_PUBLIC_URL.replace('https', 'ws')} ${process.env.NEXT_PUBLIC_URL} 'self';
